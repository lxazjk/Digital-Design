...
set_property PACKAGE_PIN V14 [get_ports {BTN_Y[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {BTN_Y[1]}]
set_property PACKAGE_PIN W14 [get_ports {BTN_Y[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {BTN_Y[0]}]
set_property PACKAGE_PIN V18 [get_ports {BTN_Y[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {BTN_Y[3]}]
set_property PACKAGE_PIN V19 [get_ports {BTN_Y[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {BTN_Y[2]}]

set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets BTN_Y*]
