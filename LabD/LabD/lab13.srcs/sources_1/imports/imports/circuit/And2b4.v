   ...
   *******************************************************************************/
   AND_GATE #(.BubblesMask(2'b00))
      GATES_1 (.input1(s_logisimBus13[0]),
               ...
               .result(s_logisimBus4[0]));

   AND_GATE #(.BubblesMask(2'b00))
      GATES_2 (.input1(s_logisimBus13[1]),
               .input2(s_logisimBus14[1]),
               .result(s_logisimBus4[1]));

   AND_GATE #(.BubblesMask(2'b00))
      GATES_3 (.input1(s_logisimBus13[2]),
               .input2(s_logisimBus14[2]),
               .result(s_logisimBus4[2]));

   AND_GATE #(.BubblesMask(2'b00))
      GATES_4 (.input1(s_logisimBus13[3]),
               .input2(s_logisimBus14[3]),
               .result(s_logisimBus4[3]));
